function varargout = A15_2FnnlsTissue(varargin)
% A15_2FNNLSTISSUE MATLAB code for A15_2FnnlsTissue.fig
%      A15_2FNNLSTISSUE, by itself, creates a new A15_2FNNLSTISSUE or raises the existing
%      singleton*.
%
%      H = A15_2FNNLSTISSUE returns the handle to a new A15_2FNNLSTISSUE or the handle to
%      the existing singleton*.
%
%      A15_2FNNLSTISSUE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in A15_2FNNLSTISSUE.M with the given input arguments.
%
%      A15_2FNNLSTISSUE('Property','Value',...) creates a new A15_2FNNLSTISSUE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before A15_2FnnlsTissue_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to A15_2FnnlsTissue_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help A15_2FnnlsTissue

% Last Modified by GUIDE v2.5 19-Jan-2018 12:45:54
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @A15_2FnnlsTissue_OpeningFcn, ...
                   'gui_OutputFcn',  @A15_2FnnlsTissue_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before A15_2FnnlsTissue is made visible.
function A15_2FnnlsTissue_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to A15_2FnnlsTissue (see VARARGIN)

% Choose default command line output for A15_2FnnlsTissue
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes A15_2FnnlsTissue wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = A15_2FnnlsTissue_OutputFcn(hObject, eventdata, handles) 
