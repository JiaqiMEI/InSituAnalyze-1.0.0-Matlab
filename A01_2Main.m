function varargout = A01_2Main(varargin)
% A01_2MAIN MATLAB code for A01_2Main.fig
%      A01_2MAIN, by itself, creates a new A01_2MAIN or raises the existing
%      singleton*.
%
%      H = A01_2MAIN returns the handle to a new A01_2MAIN or the handle to
%      the existing singleton*.
%
%      A01_2MAIN('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in A01_2MAIN.M with the given input arguments.
%
%      A01_2MAIN('Property','Value',...) creates a new A01_2MAIN or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before A01_2Main_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to A01_2Main_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help A01_2Main

% Last Modified by GUIDE v2.5 18-Jan-2018 11:10:39

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @A01_2Main_OpeningFcn, ...
                   'gui_OutputFcn',  @A01_2Main_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before A01_2Main is made visible.
function A01_2Main_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to A01_2Main (see VARARGIN)

% Choose default command line output for A01_2Main
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes A01_2Main wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = A01_2Main_OutputFcn(hObject, eventdata, handles) 
...
fore=A02_2Foreground(handles.figure1);
...
Data2D=fData2D;
%set(handles.figure1,'Visible','off');
open A12_2CharacteristicBand.fig 
...
%set(A01_2Main,'Visible','off');
open A13_2CharacteristicTissue.fig
