function varargout = A02_1Foreground(varargin)
% A02_1FOREGROUND MATLAB code for A02_1Foreground.fig
%      A02_1FOREGROUND, by itself, creates a new A02_1FOREGROUND or raises the existing
%      singleton*.
%
%      H = A02_1FOREGROUND returns the handle to a new A02_1FOREGROUND or the handle to
%      the existing singleton*.
%
%      A02_1FOREGROUND('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in A02_1FOREGROUND.M with the given input arguments.
%
%      A02_1FOREGROUND('Property','Value',...) creates a new A02_1FOREGROUND or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before A02_1Foreground_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to A02_1Foreground_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help A02_1Foreground

% Last Modified by GUIDE v2.5 31-Oct-2017 13:06:11
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @A02_1Foreground_OpeningFcn, ...
                   'gui_OutputFcn',  @A02_1Foreground_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before A02_1Foreground is made visible.
function A02_1Foreground_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to A02_1Foreground (see VARARGIN)
...
% Choose default command line output for A02_1Foreground
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes A02_1Foreground wait for user response (see UIRESUME)
uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = A02_1Foreground_OutputFcn(hObject, eventdata, handles) 
