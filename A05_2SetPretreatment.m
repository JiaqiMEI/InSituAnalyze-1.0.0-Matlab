function varargout = A05_2SetPretreatment(varargin)
% A05_2SETPRETREATMENT MATLAB code for A05_2SetPretreatment.fig
%      A05_2SETPRETREATMENT, by itself, creates a new A05_2SETPRETREATMENT or raises the existing
%      singleton*.
%
%      H = A05_2SETPRETREATMENT returns the handle to a new A05_2SETPRETREATMENT or the handle to
%      the existing singleton*.
%
%      A05_2SETPRETREATMENT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in A05_2SETPRETREATMENT.M with the given input arguments.
%
%      A05_2SETPRETREATMENT('Property','Value',...) creates a new A05_2SETPRETREATMENT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before A05_2SetPretreatment_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to A05_2SetPretreatment_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help A05_2SetPretreatment

% Last Modified by GUIDE v2.5 28-Feb-2018 19:45:13

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @A05_2SetPretreatment_OpeningFcn, ...
                   'gui_OutputFcn',  @A05_2SetPretreatment_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before A05_2SetPretreatment is made visible.
function A05_2SetPretreatment_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to A05_2SetPretreatment (see VARARGIN)
...
% Choose default command line output for A05_2SetPretreatment
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes A05_2SetPretreatment wait for user response (see UIRESUME)
%uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = A05_2SetPretreatment_OutputFcn(hObject, eventdata, handles) 
