function varargout = A14_1FNNLS(varargin)
% A14_1FNNLS MATLAB code for A14_1FNNLS.fig
%      A14_1FNNLS, by itself, creates a new A14_1FNNLS or raises the existing
%      singleton*.
%
%      H = A14_1FNNLS returns the handle to a new A14_1FNNLS or the handle to
%      the existing singleton*.
%
%      A14_1FNNLS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in A14_1FNNLS.M with the given input arguments.
%
%      A14_1FNNLS('Property','Value',...) creates a new A14_1FNNLS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before A14_1FNNLS_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to A14_1FNNLS_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help A14_1FNNLS

% Last Modified by GUIDE v2.5 19-Jan-2018 12:45:07

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @A14_1FNNLS_OpeningFcn, ...
                   'gui_OutputFcn',  @A14_1FNNLS_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before A14_1FNNLS is made visible.
function A14_1FNNLS_OpeningFcn(hObject, ~, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to A14_1FNNLS (see VARARGIN)
...
% Choose default command line output for A14_1FNNLS
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes A14_1FNNLS wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = A14_1FNNLS_OutputFcn(hObject, ~, handles) 
